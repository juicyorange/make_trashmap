          ...
          */
          ...
          for(var i=0;i<marker_data.length;i++){
            ...
            '<form action="/invisible_wait" method="post">'+
                '<textarea name="addr">'+where+'</textarea>'+
                '<input type="hidden" name="lat" value='+marker_data[i]['trash_lat']+'>'+
                '<input type="hidden" name="lng" value='+marker_data[i]['trash_lng']+'>'+
                '<input type="hidden" name="gu_name" value='+marker_data[i]['gu_name']+'>'+
